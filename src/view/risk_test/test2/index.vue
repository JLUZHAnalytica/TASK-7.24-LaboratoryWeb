                                ...
                                <div class="main" id="right" style="height:800px;width:1200px;float:left;">    
                                    ...
                                    <div class="main-main" >
                                        <div class="question">
                                            ...
                                            <b>2.您家庭预计进行证券投资的资金占家庭现有总资产（不含自住、自用房产及汽车等固定资产）的比例是（    ）。</b>
                                        </div>
                                        <div class="answer" >
                                            <div>
                                                <el-radio v-model="radio1" label="1"  border>A.70%以上</el-radio>
                                                <el-radio v-model="radio1" label="2"  border>B.50%-70%</el-radio>
                                            </div>
                                            <div>
                                                <el-radio v-model="radio1" label="3" border>C.30%-50%</el-radio>
                                                <el-radio v-model="radio1" label="4" border>D.10%-30%</el-radio>
                                            </div>
                                            <div>
                                                <el-radio v-model="radio1" label="5" border>E.10%以下</el-radio>
                                            </div>
                                        </div>
                                    </div>  
                                    <div class="botton">
  ...
  export default {
    ...
    methods:{
        lastpage(){
          ...
          //指定跳转地址
          this.$router.replace('/risk_test1')
        },
        nextpage(){
         ...
         // this.$router.go(-1)
          ...
          //指定跳转地址
          this.$router.replace('/risk_test3')
        }
    }
  }
</script>